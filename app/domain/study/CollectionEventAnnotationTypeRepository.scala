...
trait CollectionEventAnnotationTypeRepositoryComponent {
  ...
  trait CollectionEventAnnotationTypeRepository {
    ...
    def allCollectionEventAnnotationTypesForStudy(
      studyId: StudyId): Set[CollectionEventAnnotationType]
...
trait CollectionEventAnnotationTypeRepositoryComponentImpl
  ...
  override val collectionEventAnnotationTypeRepository: CollectionEventAnnotationTypeRepository = new CollectionEventAnnotationTypeRepositoryImpl

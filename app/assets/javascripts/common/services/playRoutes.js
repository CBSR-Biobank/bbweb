...
define(['angular', 'require', 'jsRoutes'], function(angular, require, jsRoutes) {
  ...
  mod.service('playRoutes', ['$http', function($http) {
    ...
    var createPlayRoutes = function(controllerObject, playRoutes) {
      // Loop over all items in the jsRoutes generated by Play, wrap and add them to playRoutes
      for (var controllerMethodKey in controllerObject) {
        playRoutes[controllerMethodKey] = wrapHttp(controllerObject[controllerMethodKey]);
      }
      return playRoutes;
    };

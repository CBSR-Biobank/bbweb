define(['../module'], function(module) {
  ...
  module.service('modelObjRemoveService', modelObjRemoveService);

  modelObjRemoveService.$inject = ['$state', 'modalService'];

  /**
   *
   */
  function modelObjRemoveService($state, modalService) {
    var service = {
      remove : remove
    };
    return service;

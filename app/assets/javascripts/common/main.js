...
define(function (require) {
  ...
  module = angular.module('biobank.common', [ modalInputModule.name, annotationsInputModule.name ])
    ...
    .controller('EntityTimestampsController',    require('./controllers/EntityTimestampsController'))
    ...
    .component('entityTimestamps',        require('./components/entityTimestamps/entityTimestampsComponent'))
    ...
    .component('stateAndTimestamps',      require('./components/stateAndTimestamps/stateAndTimestampsComponent'))

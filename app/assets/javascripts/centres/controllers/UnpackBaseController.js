...
define(function (require) {
  ...
  UnpackBaseController.$inject = ['vm', 'modalService', 'gettextCatalog'];
  ...
  function UnpackBaseController(vm, modalService, gettextCatalog) {
    ...
    vm.tagSpecimensAsExtra       = tagSpecimensAsExtra;

    vm.errorIsInvalidInventoryIds        = errorIsInvalidInventoryIds;
    vm.errorIsShipSpecimensNotInShipment = errorIsShipSpecimensNotInShipment;
    vm.errorIsShipSpecimensNotPresent    = errorIsShipSpecimensNotPresent;
    vm.errorIsAlreadyInShipment          = errorIsAlreadyInShipment;
    vm.errorIsInAnotherShipment          = errorIsInAnotherShipment;
    vm.errorIsInvalidCentre              = errorIsInvalidCentre;

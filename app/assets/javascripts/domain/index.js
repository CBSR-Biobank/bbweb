...
const DomainModule = angular.module('biobank.domain', [])
      ...
      .constant('ShipmentItemState',                  require('./centre/ShipmentItemState/ShipmentItemState'))
      ...
      .factory('ProcessingTypeViewer',                require('./study/ProcessingTypeViewer/ProcessingTypeViewer'))
      ...
      .factory('SpecimenGroupViewer',                 require('./study/SpecimenGroupViewer/SpecimenGroupViewer'))
      ...
      .factory('StudyViewer',                         require('./study/StudyViewer/StudyViewer'))
      ...
      .constant('UserState',                         require('./user/UserState/UserState'))
      .constant('StudyState',                        require('./study/StudyState/StudyState'))
      .constant('CentreState',                       require('./centre/CentreState/CentreState'))
      .name;

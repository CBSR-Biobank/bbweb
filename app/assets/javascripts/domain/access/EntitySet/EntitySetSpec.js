...
define(function (require) {
  ...
  describe('EntitySet', function() {
    ...
    function SuiteMixinFactory(EntityTestSuite) {
      ...
      SuiteMixin.prototype.createEntitySetFrom = function (obj) {
        return new this.EntitySet(obj);
      };

      SuiteMixin.prototype.createEntitySet = function () {
        return new this.EntitySet(this.jsonObj());
      };
    ...
    beforeEach(inject(function(EntityTestSuite,
                               testDomainEntities) {
      _.extend(this, new SuiteMixinFactory(EntityTestSuite).prototype);

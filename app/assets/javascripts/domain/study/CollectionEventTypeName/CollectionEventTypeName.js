...
function CollectionEventTypeNameFactory($q,
  ...
  /**
   * @classdesc A CollectionEventTypeName contains the ID, name and state for a collectionEventType.
   *
  ...
  CollectionEventTypeName.list = function (studyId, options, omit) {
    return EntityName.list(CollectionEventTypeName.url(studyId), options, CollectionEventTypeName, omit);
  };

...
describe('collection states', function() {
  ...
  describe(
    'when navigating to `/collection/study/study-slug-1/participant/participant-slug-1/summary`',
    function () {
      const context = {}

      beforeEach(function() {
        context.childState = 'summary'
        context.url = '/collection/study/study-slug-1/participant/participant-slug-1/summary'
      });
  ...
  describe(
    'when navigating to `/collection/study/study-slug-1/participant/participant-slug-1/events`',
    function () {
      const context = {}

      beforeEach(function() {
        context.childState = 'cevents'
        context.url = '/collection/study/study-slug-1/participant/participant-slug-1/events'
      });

      participantSharedBehaviour(context)
    })

  it('when navigating to `/collection/study/study-slug-1/participant/participant-slug-1/events/add` should go to valid state',
     function () {
       ...
       this.gotoUrl('/collection/study/study-slug-1/participant/participant-slug-1/events/add')
       expect(this.$state.current.name).toBe('home.collection.study.participant.cevents.add')
     })

  describe(
    'when navigating to `/collection/study/study-slug-1/participant/participant-slug-1/events/add/collection-event-type-id-1`',
    function () {
      ...
      it('should go to valid state', function() {
        ...
        this.gotoUrl(
          '/collection/study/study-slug-1/participant/participant-slug-1/events/add/collection-event-type-id-1')
  ...
  describe(
    'navigating to `/collection/study/study-slug-1/participant/participant-slug-1/events/event-type-id-1/event-id-1`',
    function () {
      ...
      it('should go to valid state', function () {
        ...
        this.gotoUrl(
          '/collection/study/study-slug-1/participant/participant-slug-1/events/event-id-1')
      ...
      it('should go to the 404 state when an invalid eventId is used', function() {
        this.CollectionEventType.get = jasmine.createSpy().and.returnValue(this.$q.reject('simulated error'))
        this.gotoUrl(
          '/collection/study/study-slug-1/participant/participant-slug-1/events/add/event-type-id-1')
        expect(this.$state.current.name).toBe('404')
      })
    })

  describe(
    'when navigating to `/collection/study/study-slug-1/participant/participant-slug-1/events/event-id-1/specimen-inv-id-1`',
    function () {
      ...
      it('should go to valid state', function() {
        ...
        this.gotoUrl(
          '/collection/study/study-slug-1/participant/participant-slug-1/events/event-id-1/specimen-inv-id-1')

...
describe('collection states', function() {
  ...
  describe('when navigating to `/collection/study/study-id-1`', function () {

    it('should go to valid state', function () {
      this.Study.get = jasmine.createSpy().and.returnValue(this.$q.when({}))
      this.gotoUrl('/collection/study/study-id-1')
  ...
  it('when navigating to `/collection/study/study-id-1/add/participant-id-1` should go to valid state',
     function () {
       this.Study.get = jasmine.createSpy().and.returnValue(this.$q.when({}))
       this.gotoUrl('/collection/study/study-id-1/add/participant-id-1')
       expect(this.$state.current.name).toBe('home.collection.study.participantAdd')
     })

  describe(
    'when navigating to `/collection/study/study-id-1/participant/participant-id-1/summary`',
    function () {
      const context = {}

      beforeEach(function() {
        context.childState = 'summary'
        context.url = '/collection/study/study-id-1/participant/participant-id-1/summary'
      });
  ...
  describe(
    'when navigating to `/collection/study/study-id-1/participant/participant-id-1/cevents`',
    function () {
      const context = {}

      beforeEach(function() {
        context.childState = 'cevents'
        context.url = '/collection/study/study-id-1/participant/participant-id-1/cevents'
      });

      participantSharedBehaviour(context)
    })

  it('when navigating to `/collection/study/study-id-1/participant/participant-id-1/cevents/add` should go to valid state',
     function () {
       ...
       this.gotoUrl('/collection/study/study-id-1/participant/participant-id-1/cevents/add')
       expect(this.$state.current.name).toBe('home.collection.study.participant.cevents.add')
     })

  describe(
    'when navigating to `/collection/study/study-id-1/participant/participant-id-1/cevents/add/collection-event-type-id-1`',
    function () {
      ...
      it('should go to valid state', function() {
        ...
        this.gotoUrl(
          '/collection/study/study-id-1/participant/participant-id-1/cevents/add/collection-event-type-id-1')
  ...
  describe(
    'navigating to `/collection/study/study-id-1/participant/participant-id-1/cevents/event-type-id-1/event-id-1`',
    function () {
      ...
      it('should go to valid state', function () {
        ...
        this.CollectionEvent.get = jasmine.createSpy().and.returnValue(this.$q.when(collectionEvent))

        this.gotoUrl(
          '/collection/study/study-id-1/participant/participant-id-1/cevents/event-type-id-1/event-id-1')
      ...
      it('should go to the 404 state when an invalid eventId is used', function() {
        this.CollectionEvent.get = jasmine.createSpy().and.returnValue(this.$q.reject('simulated error'))
        this.gotoUrl(
          '/collection/study/study-id-1/participant/participant-id-1/cevents/add/event-type-id-1/event-id-1')
        expect(this.$state.current.name).toBe('404')
      })
    })

  describe(
    'when navigating to `/collection/study/study-id-1/participant/participant-id-1/cevents/event-type-id-1/event-id-1/specimen-inv-id-1`',
    function () {
      ...
      it('should go to valid state', function() {
        ...
        this.Specimen.getByInventoryId = jasmine.createSpy().and.returnValue(this.$q.when(specimen))

        this.gotoUrl(
          '/collection/study/study-id-1/participant/participant-id-1/cevents/event-type-id-1/event-id-1/specimen-inv-id-1')
        expect(this.$state.current.name).toBe('home.collection.study.participant.cevents.details.specimen')
      })

      it('should go to the 404 state when an invalid eventId is used', function() {
        this.Specimen.getByInventoryId = jasmine.createSpy().and.returnValue(this.$q.reject('simulated error'))
        this.gotoUrl(
          '/collection/study/study-id-1/participant/participant-id-1/cevents/event-type-id-1/event-id-1/specimen-inv-id-1')
        expect(this.$state.current.name).toBe('404')
      })

...
class SpecimenLinkAnnotationTypeSpec extends Specification with NoTimeConversions with Tags with StudyFixture {
  args(
    //include = "tag1",
  ...
  "SpecimenLink annotation type" can {
    ...
    "be added" in {
      ...
      val at1 = await(studyService.addSpecimenLinkAnnotationType(
        new AddSpecimenLinkAnnotationTypeCmd(study.id.toString, name, Some(name), valueType)))
      ...
      val at2 = await(studyService.addSpecimenLinkAnnotationType(
        new AddSpecimenLinkAnnotationTypeCmd(study.id.toString, name2, None,
    ...
    "not be added if name already exists" in {
      ...
      val at1 = await(studyService.addSpecimenLinkAnnotationType(
        new AddSpecimenLinkAnnotationTypeCmd(study.id.toString, name, Some(name),
